  ...
  <div class="modal is-active">
    <div class="modal-background"></div>
      <div class="modal-card">
        ...
        <label class="label is-white"></label>
          <div class="control">
            <input required id="password-input" class="input" type="password" placeholder="confirm password">
          </div>
        </div>


        <br>
        <button id="sign-up"class="button is-primary is-pulled left">Submit</button>
